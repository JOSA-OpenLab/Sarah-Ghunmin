...
bonus: I used `git cat-file` on the parent hash, and since there is only 3 commits I was able to perform the command 2 times until i got to the first commit which has no parent.